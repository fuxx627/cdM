...
from ultralytics.nn.modules.LowLightEnhancer import LowLightEnhancer

__all__ = ('DFL', 'HGBlock', 'HGStem', 'SPP', 'SPPF', 'C1', 'C2', 'C3', 'C2f', 'C3x', 'C3TR', 'C3Ghost',
           'GhostBottleneck', 'Bottleneck', 'BottleneckCSP', 'Proto', 'RepC3', 'ResNetLayer', 'C2f_DySnakeConv')
...
class LowLightEnhancer(nn.Module):
    ...
    def forward(self, x):
        ...
        return torch.clamp(x + self.alpha * attn * base, 0, 1)
