...
from ultralytics.nn.modules.gold_yolo import Low_FAM, Low_IFM, Split, SimConv, Low_LAF, Inject, RepBlock, High_FAM, High_LAF
import torch
...
def parse_model(d, ch, verbose=True):  # model_dict, input_channels(3)
    ...
    for i, (f, n, m, args) in enumerate(d["backbone"] + d["head"]):  # from, number, module, args
        ...
        if m in {
            ...
            C3x,
            RepC3,
            SimpleStem, VisionClueMerge, VSSBlock, XSSBlock, VoVGSCSP, VoVGSCSPC, GSConv, SimConv, SEAttention,
        }:
            c1, c2 = ch[f], args[0]
            ...
            args = [c1, c2, *args[1:]]
            if m in {BottleneckCSP, C1, C2, C2f, C2fAttn, C3, C3TR, C3Ghost, C3x, RepC3, XSSBlock, C2f_GhostConv,}:
